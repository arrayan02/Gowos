...
<section class="banner"
		 style="background-image: url(<?= base_url('assets_pelanggan/'); ?>css/bg-image/category-bg3.jpg); background-size: cover;">
...
<section class="popular-foods padding-tb" style="background-color: #fafeff;">
	<div class="container">
		<div class="section-header">
			<h3>Selamat Datang Di tempat pencucian GOWOS</h3>
			<p>cuci mobil maupun motor anda dijamin bersih tanpa noda.</p>
		</div>
						...
						<div class="p-food-item">
							<div class="p-food-inner">
								<div class="p-food-thumb">
									<a href="<?= base_url('Pelanggan/tempat/') . $tempat_cuci->id; ?>"><img
												style="width: 340px; height: 250px;object-fit: cover;"
												src="<?= base_url('uploads/tempat_cuci/foto2/'); ?><?= $tempat_cuci->foto2; ?>"
												alt="p-food"></a>
								...
								<div class="p-food-content">
									<div class="p-food-author">
										<a href="<?= base_url('Pelanggan/tempat/') . $tempat_cuci->id; ?>"><img
													...
													src="<?= base_url('uploads/tempat_cuci/foto1/'); ?><?= $tempat_cuci->foto1; ?>"
													alt="food-author"></a>
									</div>
									<h6>
										<a href="<?= base_url('Pelanggan/tempat/') . $tempat_cuci->id; ?>"><?= $tempat_cuci->nama; ?></a>
									</h6>
									...
									<div class="p-food-footer">
										...
										<div class="right"><i class="icofont-home"></i><?= $tempat_cuci->alamat; ?>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="service-item">
				<div class="service-inner">
					...
					<div class="service-content">
						<h6><a href="#">Pilih Metode Pembayaran</a></h6>
					</div>
				</div>
			</div>
			<div class="service-item">
